...
class SettingsFragment : PreferenceFragmentCompat(), SettingsFragmentContract.View, SharedPreferences.OnSharedPreferenceChangeListener {
    companion object {
        fun newInstance() = SettingsFragment()
    }
    private lateinit var presenter: SettingsFragmentContract.Presenter
